...
private const val DRAWABLE_RESOURCES_MAIN_PATH =
    "compose-resources/composeResources/com.retrowax.zombusters.resources/drawable"
private const val FONT_RESOURCES_MAIN_PATH =
    "compose-resources/composeResources/com.retrowax.zombusters.resources/font"
private const val FILES_RESOURCES_MAIN_PATH =
    "compose-resources/composeResources/com.retrowax.zombusters.resources/files"

@OptIn(ExperimentalComposeUiApi::class)
@Composable
actual fun KorgeView(modifier: Modifier, exit: () -> Unit) {
    val viewHeight = LocalWindowInfo.current.containerSize.height.pxToPoint()
    val viewWidth = LocalWindowInfo.current.containerSize.width.pxToPoint()
    val buttonBackgroundColor = MaterialTheme.colorScheme.secondary.toKorgeColor()

    val mainScene = MainGameScene(
    ...
    val viewInfo = ZombustersKorgeIosUIViewProvider().createViewInfo(
        mainScene,
        viewWidth.toInt(),
        viewHeight.toInt()
    )
...
class ZombustersKorgeIosUIViewProvider : BaseKorgeIosUIViewProvider()
