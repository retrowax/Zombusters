...
import com.retrowax.zombusters.game.model.RAT_MAX_VELOCITY

// Port of legacy Rat.cs — MAX_VELOCITY 1.5, MAX_STRENGTH 0.15
class Rat(
    position: Vec2,
...
) : BaseEnemy(EnemyType.RAT, position, boundingRadius, MAX_STRENGTH, obstacles) {

    companion object {
        const val MAX_STRENGTH = 0.15f
        const val X_OFFSET = 20  // from legacy Rat.cs
        const val Y_OFFSET = 48  // from legacy Rat.cs
    }

    init {
        entity.maxSpeed = RAT_MAX_VELOCITY + speed
