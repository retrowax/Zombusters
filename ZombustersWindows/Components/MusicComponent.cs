    ...
    public class MusicComponent : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public override void Update(GameTime gameTime)
        {
            if (MediaPlayer.GameHasControl)
            {
                ...
                if (((GamePad.GetState(((MyGame)this.Game).players[0].playerIndex).Buttons.LeftShoulder == ButtonState.Pressed) || (GamePad.GetState(((MyGame)this.Game).players[1].playerIndex).Buttons.LeftShoulder == ButtonState.Pressed) ||
                    (GamePad.GetState(((MyGame)this.Game).players[2].playerIndex).Buttons.LeftShoulder == ButtonState.Pressed) || (GamePad.GetState(((MyGame)this.Game).players[3].playerIndex).Buttons.LeftShoulder == ButtonState.Pressed))
                    && buttonReleased == true)
                {
                    if (ShowText == false)
                    {
                ...
                if ((GamePad.GetState(((MyGame)this.Game).players[0].playerIndex).Buttons.LeftShoulder == ButtonState.Released) && (GamePad.GetState(((MyGame)this.Game).players[1].playerIndex).Buttons.LeftShoulder == ButtonState.Released) &&
                    (GamePad.GetState(((MyGame)this.Game).players[2].playerIndex).Buttons.LeftShoulder == ButtonState.Released) && (GamePad.GetState(((MyGame)this.Game).players[3].playerIndex).Buttons.LeftShoulder == ButtonState.Released))
                {
                    buttonReleased = true;
                }
